...
<body oncontextmenu="return false;">
    ...
    <div class="dashboard-container">
        ...
        <div class="main-content" id="mainContent">
            <h1><i class="fas fa-trash-alt"></i> Delete File</h1>
            ...
            <div class="confirmation-container">
                ...
                <div class="confirmation-message">
                    <h2>Are you sure?</h2>
                    <p>This action cannot be undone. This will permanently delete the file from the server.</p>
                </div>
                
                <?php if ($file['filetype'] === 'image' || $file['filetype'] === 'video'): ?>
                <div class="file-preview">
                    <?php if ($file['filetype'] === 'image'): ?>
                        <img src="../user/<?php echo htmlspecialchars($file['filepath']); ?>" 
                             alt="<?php echo htmlspecialchars($file['filename']); ?>">
                    <?php else: ?>
                        <video controls>
                            <source src="../user/<?php echo htmlspecialchars($file['filepath']); ?>" 
                ...
                <div class="file-details">
                    <p><strong>File ID:</strong> <?php echo htmlspecialchars($file['id']); ?></p>
                    <p><strong>Filename:</strong> <?php echo htmlspecialchars($file['filename']); ?></p>
                    <p><strong>Type:</strong> <?php echo ucfirst(htmlspecialchars($file['filetype'])); ?></p>
                    <p><strong>Uploaded by:</strong> <?php echo htmlspecialchars($file['username']); ?> (<?php echo htmlspecialchars($file['email']); ?>)</p>
                    <p><strong>Uploaded at:</strong> <?php echo date('M d, Y H:i', strtotime($file['uploaded_at'])); ?></p>
                </div>
